...
// deserialization
// // of saved data. It is not directly used in this example but still
// required. Factory::sInstance = new Factory();
//
...
// during
// // the physics update. B.t.w. 10 MB is way too much for this example but it
// is
// // a typical value you can use. If you don't want to pre-allocate you can
// also
...
// will
// // start to do narrow phase work. This is slightly less efficient. Note:
// This
...
// // through the world. Note: This value is low because this is a simple
// test.
...
// optional. MyContactListener contact_listener;
// physics_system.SetContactListener(&contact_listener);
//
// // The main way to interact with the bodies in the physics system is
// through
// // the body interface. There is a locking and a non-locking variant of
// this.
// // We're going to use the locking version (even though we're not planning
// to
// // access bodies from multiple threads)
// BodyInterface &body_interface = physics_system.GetBodyInterface();
// // expose the body interface
//
...
// floor_shape_settings.Create(); ShapeRefC floor_shape =
//     floor_shape_result
...
// BodyCreationSettings floor_settings(floor_shape, RVec3(0.0_r, -1.0_r,
// 0.0_r),
...
// the
// // broad phase. This improves collision detection performance (it's
// pointless
...
// // expensive operation. Instead insert all new objects in batches instead
// of 1
...
void PhysicsManager::init() {
  physicsSystem.Init(maxBodies, numBodyMutexes, maxBodyPairs,
                     maxContactConstraints, broadPhaseLayer,
...
void PhysicsManager::createWorld() {
  ...
  sphereId =
      bodyInterface->CreateAndAddBody(sphere_settings, EActivation::Activate);
